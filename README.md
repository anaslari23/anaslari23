...
- **Computer Vision:** Face recognition, document analysis, forgery detection, and OCR pipelines.
- **Reinforcement Learning:** Custom training environments and intelligent agent design.
- **Performance:** Multimodal reasoning engines, dataset creation, and model quantization.

#### Web & Backend Engineering
- **Architecture:** Microservices, distributed systems, and real-time WebSocket communication.
- **Backend APIs:** Robust service layers with FastAPI, Node.js/Express, and Laravel.
- **Frontend UI/UX:** Component-driven, responsive applications with React and Next.js.
- **Security & Data:** Secure JWT/OAuth2 authentication, task queues, and data pipeline management.

#### Mobile Engineering
- **Frameworks:** Production-grade Flutter apps using BLoC, Provider, and Riverpod.
- **Cloud Integration:** Firebase Authentication, Firestore, and scalable Cloud Functions.
- **Experience:** Custom animations, responsive layouts, and native platform integrations.

#### Databases & DevOps
- **Data Stores:** PostgreSQL, MySQL, Redis, and Firestore.
- **Containerization:** Dockerized backend and AI workflows.
- **CI/CD:** Automated build, test, and deploy pipelines using GitHub Actions.
- **Infrastructure:** Linux server configuration, deployment, and systems administration.
